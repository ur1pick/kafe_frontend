...
function Main() {
            ...
            if((cookies.id==='undefined')||(cookies===null)||(cookies.id===undefined)){
                axios.post(`${window.location.origin}/api/shorturl`, {
                    ...
                    if(res.data.length!==0){
                        setResult(!result);
                        setRandomUrl(`/${res.data.data.shortUrl}`);
                    }else{
    ...
    return (
        <div className="min-h-screen flex flex-col w-full h-full">
            ...
            {/*    <div className="mt-[40px] cursor-default select-none">*/}
            ...
            {/*        </div>*/}
                    ...
                    {/*{result*/}
                    {/*    ?*/}
                    {/*    <div className="flex flex-row justify-center cursor-default mt-[40px] mb-[20px] select-none pb-[10px] cursor-pointer">*/}
                    ...
                    {/*                    </DialogBody>*/}
                    {/*                    <DialogFooter>*/}
                    {/*                        <span onClick={handleQr}*/}
                    {/*                              className="cursor-pointer mx-[15px] font-suit font-semibold text-[#81664D]">취소</span>*/}
                    {/*                        <a id="btnSave" className="cursor-pointer bg-[#FEDB82] px-[10px] rounded-[6px] font-suit font-semibold text-[#ffffff]" onClick={()=>btnSave(randomUrl)}>저장</a>*/}
                    {/*                    </DialogFooter>*/}
                    {/*                </Dialog>*/}
                    {/*            </Fragment>*/}
                    {/*        </div>*/}
            ...
            <main>
                <div className="mx-auto max-w-7xl my-6 sm:px-6 lg:px-8">
