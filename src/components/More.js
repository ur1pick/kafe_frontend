...
function More({result,setResult,original}){
    ...
    const btnSearch = () => {
        if(custom.length!==0){
            axios.get(`${window.location.origin}/api/shorturl/check/${custom}`,{
                headers: {
                    ...
                    if(isDuplicate){
                        ...
                        if(activate){
                            if(isPass){
                                ...
                                axios.post(`${window.location.origin}/api/shorturl`,
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        setCustomUrl(`/${res.data.data.shortUrl}`);
                                    }).catch(function (err) {
                                        console.log(err);
                                    });
                                }
    ...
    return(
        <div className="m-[10px] justify-center flex flex-col gap-[15px] border-2 border-[#CACACA] p-[20px] w-fit mx-auto rounded-[12px]">

            <p className="text-[22px] text-black font-suit font-bold place-self-center text-center">나만의 URL</p>
                ...
                <div className="text-center place-self-center">
                    <label className="inline-flex items-center">
                        <input type="checkbox" className="rounded bg-white/0 border-[#767676] border-[2px]
                               ...
                               onClick={checkCustom}/>
                        <span className="ml-2 font-suit font-medium text-[20px]">사용자 지정</span>
                    </label>
                </div>
                <div className="text-center place-self-center">
                    <label className="inline-flex items-center">
                        ...
                        <span className="ml-2 font-suit font-medium text-[20px]">유효 기간</span>
                    </label>
                </div>
                <div className="text-center place-self-center align-middle">
                    <label className="inline-flex items-center">
                        <input type="checkbox" className="rounded bg-white/0 border-[#767676] border-[2px]
                                  ...
                                  focus:ring-1 focus:ring-offset-2 focus:ring-[#FEDB82]/[0.5]"
                               onClick={checkPass}/>
                        <span className="ml-2 font-suit font-medium text-[20px]">비밀번호</span>
                    </label>
                </div>
            </div>
...

            {
                ...
                <div className="mx-auto place-self-center">
                    <label className="text-[#000000] font-suit font-medium text-[20px] text-center">/</label>
                    ...
                    <span className="py-[5px] px-[10px] rounded-[8px] bg-[#FEDB82] text-[#FFFFFF]  font-suit font-bold text-[20px] text-center cursor-pointer" onClick={btnSearch}>조회 🔍</span>
                </div>
            }
            {
                activate&&
            ...
            {customResult
                ...
                //                     <span className="group items-center text-[#000000] font-suit font-semibold text-[26px] text-center align-middle  mx-[10px] border-b-[7px] border-[#FEDB82]" >{customUrl}</span>
                ...
                //                     취소
                //                 </span>
                //                 <a id="btnCustomSave" className="cursor-pointer bg-[#FEDB82] px-[10px] rounded-[6px] font-suit font-medium text-[#ffffff]" onClick={()=>btnCustomSave(customUrl)}>
                //                     저장
                //                 </a>
                //             </DialogFooter>
                //         </Dialog>
